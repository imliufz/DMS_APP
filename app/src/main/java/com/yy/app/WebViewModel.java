...
public class WebViewModel implements ICore.ICoreStatusListener {
    ...
    public WebViewModel(Activity activity, ViewGroup rootView) {
    ...
    public void onCoreInitEnd(ICore coreHandler) {
        ...
        String url = "https://www.baidu.com";//file:///android_asset/apps/H5Plugin/www/index.html
